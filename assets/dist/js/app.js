...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  data: function data() {
    return {
      ...
      errors: new FormErrors(window.RcpFileProtector['errors'] ? window.RcpFileProtector['errors'] : []),
      successMessage: window.RcpFileProtector['successMessage']
    };
  },
  methods: {
    addProtectionLevel: function addProtectionLevel() {
    ...
    removeProtectionLevel: function removeProtectionLevel(index) {
    ...
    validate: function validate() {
      ...
      this.errors.clear();
      this.protectionLevels.forEach(function (level, index) {
        if (!level['memberships'] || level['memberships'].length == 0) {
          _this.errors.add('levels', "Protection level #".concat(index + 1, ": Memberships can't be empty."));
        }

        if (!level['url']) {
          _this.errors.add('levels', "Protection level #".concat(index + 1, ": URL can't be empty."));
        }
      });
...
/***/ "./assets/src/scss/rcp-file-protector.scss":
/*!*************************************************!*\
  !*** ./assets/src/scss/rcp-file-protector.scss ***!
  \*************************************************/
...
/***/ 0:
/*!******************************************************************************!*\
  !*** multi ./assets/src/js/app.js ./assets/src/scss/rcp-file-protector.scss ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/macbook/Sites/memberly/wp-content/plugins/rcp-file-protector/assets/src/js/app.js */"./assets/src/js/app.js");
module.exports = __webpack_require__(/*! /Users/macbook/Sites/memberly/wp-content/plugins/rcp-file-protector/assets/src/scss/rcp-file-protector.scss */"./assets/src/scss/rcp-file-protector.scss");
